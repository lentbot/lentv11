...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=628165466368:+62 816-5466-368n' // JANGAN KEK BABI SU
...
const config = {
    A187: 'MASLENT', // TOBAT SU ASU
    instagram: 'https://instagram.com/maslent11', // INFO JANGAN DI UBAH
    nomer: 'wa.me/628165466368', // INFO SU JNGAN DI UBAH
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Subs Maslent Yt'))
	})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["628165466368@s.whatsapp.net"] // ganti nomer lu
